...
redirect_from:
  ...
  - /2024/02/07/new-side-project-optogrid.html
---
...
So I created Optogrid [optogrid.com](https://www.optogrid.com?utm_source=saulo_blog&utm_medium=link&utm_campaign=side_project).

The tool is used to measure PD (pupillary distance), Dual PD and Segment Height.

It took too long to be released, because every time I found a new cool thing to integrate there.
